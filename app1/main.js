...
function makelink(indexobj,txt) {
 ...
 // href: main.js:7 http://localhost/sanskrit-lexicon-scans/katyasr/app1/?5,2,3
 //console.log(href);
 let base = href.replace(/app1.*$/,'');
 //console.log(base);
 let ipage = indexobj.ipage // an integer
 let ipstr = ipage.toString().padStart(3,'0');
...
*/
 ...
 // search = ?X
 let search = url.search;  // a string, possibly empty
 let defaultval = [0,0,0]; // default value (title verse)
